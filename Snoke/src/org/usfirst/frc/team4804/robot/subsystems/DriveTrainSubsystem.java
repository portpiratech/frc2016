...
public class DriveTrainSubsystem extends Subsystem {
 ...
 // Methods
    ...
    public void drive(XboxController xbox) {
    	...
    	jonnyDrive(xbox.getLeftStickYAxis(), xbox.getLeftStickXAxis());
    	//tommyDrive(xbox.getLeftStickXAxis(), xbox.getLeftStickYAxis());
    }
    ...
    public void jonnyDrive(double leftY, double leftX){ //left stick's y value and left stick's x value
    ...
    public void tommyDrive(double leftX, double leftY) {
